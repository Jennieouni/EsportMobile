...
(function () {
  ...
  function Schedule (opt) {
    ...
    var disabledDate = opt.disabledDate ? filterDate(opt.disabledDate) : []
    var selectedDate = opt.selectedDate ? filterDate(opt.selectedDate) : []
    var disabledBefore = opt.disabledBefore ? getTimeStamp(opt.disabledBefore) : ''
    var disabledAfter = opt.disabledAfter ? getTimeStamp(opt.disabledAfter) : ''
    var showToday = opt.showToday
